// add spies and stubs;
// is's
let isArray = (t, module, prop) =>
    t.is(Object.prototype.toString.call(module[prop]), '[object Array]');
let isAsync = (t, module, prop) => {
    const Async = (async () => {}).constructor;
    t.true(module[prop] instanceof Async);
};
let isClass = (t, module, prop, expected) =>
    t.is(Object.prototype.toString.call(module[prop]), `[object ${expected}]`);
...
// nots
let isNotArray = (t, module, prop) =>
    t.not(Object.prototype.toString.call(module[prop]), '[object Array]');
let isNotAsync = (t, module, prop) => {
    const Async = (async () => {}).constructor;
    t.false(module[prop] instanceof Async);
};
let isNotClass = (t, module, prop, expected) =>
    t.not(Object.prototype.toString.call(module[prop]), `[object ${expected}]`);
